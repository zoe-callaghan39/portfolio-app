...
import cvFile from "../../assets/zoe_callaghanCV.pdf";
    ...
    <section className="cv-wrapper">
      ...
      <div className="timeline">
        <Section title="Work Experience">
          ...
          <ul>
            ...
            <li>
              ...
              contribute to CI/CD pipelines (GitHub, GitLab, Bitbucket,
              Jenkins); share testing best practices and enhance Java automation
              tests (limited scope).
            </li>
            <li>
          ...
          <ul>
            <li>
              Resolved up to 150 multichannel queries per day with a 95 %
              quality score, refining clear communication and empathy that
              inform my user-centric engineering approach.
            </li>
            <li>
            ...
            <li>
              Provided specialised support to vulnerable customers and
              championed safer-gambling practices, ensuring responsible gaming
        ...
        <Section title="Leadership &amp; Volunteering">
          ...
          <ul>
            <li>
              Representing CFG at client events, conferences and online
              workshops; offering mentorship to women transitioning into tech,
              creating community content, and actively advocating for women and
              non-binary talent in tech—expanding reach and driving inclusive
