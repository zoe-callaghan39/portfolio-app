...
const BlogPost2 = () => (
  <section className="bp2-wrapper">
    ...
    <div className="bp2-text">
      <p>
        In just over a year as a Junior Software Engineer, I found my stride and
        earned a mid-level promotion—without any magic, just deliberate habits
      ...
      <ul>
        ...
        <li>
          <strong>Share your wins.</strong> Present mini-demos in team meetings
