  ...
  <section className="bp1-wrapper">
    ...
    <div className="bp1-body">
      <div className="bp1-text">
        <p>
          Back in customer service, I never imagined trading headsets for a code
          editor— until I discovered Code First Girls. I’d been told tech
          courses cost thousands and required full-time commitment. Then I found
          a part-time web development kickstarter, tried it, and absolutely
          loved coding.
        </p>
        <p>
          ...
          breaking each subject into small, digestible chunks let me learn at my
          own speed.
        </p>
        <p>
